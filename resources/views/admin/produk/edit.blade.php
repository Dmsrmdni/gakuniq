                    ...
                    <div class="card-body">
                        <div class="mb-3">
                            ...
                            <select name="kategori_id" id="kategori"
                                ...
                                @foreach ($kategoris as $kategori)
                                    @if (old('kategori_id', $kategori->id) == $produks->sub_kategori->kategori->id)
                        ...
                        <div class="mb-3">
                            ...
                            <select name="sub_kategori_id" id="sub_kategori"
                                ...
                                @foreach ($sub_kategoris as $sub_kategori)
                                    @if (old('sub_kategori_id', $sub_kategori->id) == $produks->sub_kategori->id)
                                        <option value="{{ $sub_kategori->id }}" selected>
                                            {{ $sub_kategori->sub_kategori }}</option>
                                    @else
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" name="stok"
                                class="form-control mb-2 @error('stok') is-invalid @enderror" value="{{ $produks->stok }}">
                            @error('stok')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
