                        ...
                        <td>
                            <form action="{{ route('voucher_user.destroy', $voucher_user->id) }}" method="post">
                                ...
                                <button type="button" class="btn btn-sm btn-danger" data-bs-toggle="modal"
                                    data-bs-target="#modalCenter{{ $voucher_user->id }}"><svg xmlns="http://www.w3.org/2000/svg" width="16"
                                ...
                                <!-- Modal -->
                                <div class="modal fade" id="modalCenter{{ $voucher_user->id }}" tabindex="-1" aria-hidden="true">
