                    ...
                    <tr>
                        ...
                        <td>
                            <div class="d-flex">
                                ...
                                <div class="badge rounded-pill bg-success w-100">{{$voucher->status }}</div>
                        ...
                        <td>
                            <form action="{{ route('voucher.destroy', $voucher->id) }}" method="post">
                                @csrf
                                @method('delete')
                                <a href="{{ route('voucher.edit', $voucher->id) }}" class="btn btn-sm btn-secondary"
                                ...
                                <button type="button" class="btn btn-sm btn-danger" data-bs-toggle="modal"
                                    data-bs-target="#modalCenter{{ $voucher->id }}"><svg xmlns="http://www.w3.org/2000/svg" width="16"
                                ...
                                <!-- Modal -->
                                <div class="modal fade" id="modalCenter{{ $voucher->id }}" tabindex="-1" aria-hidden="true">
