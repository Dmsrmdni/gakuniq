...
@section('content')
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <button type="button" class="btn btn-sm btn-secondary" data-bs-toggle="modal"
                                            data-bs-target="#modalEdit{{ $voucher->id }}"> <svg
                                        ...
                                        <form action="{{ route('voucher.update', $voucher->id) }}" method="post">
                                            ...
                                            @method('put')
                                            <!-- Modal -->
                                            <div class="modal fade" id="modalEdit{{ $voucher->id }}" tabindex="-1"
                                                aria-hidden="true">
                                                <div class="modal-dialog modal-dialog-centered" role="document">
                                                    <div class="modal-content">
                                                        <div class="modal-header">
                                                            <h5 class="modal-title" id="modalCenterTitle">Edit Status
                                                                Voucher</h5>
                                                        </div>
                                                            ...
                                                            <div class="row">
                                                                <div class="col mb-3">
                                                                    ...
                                                                    <select name="status"
                                                                        ...
                                                                        <option value="{{ $voucher->status }}" selected
                                                                            hidden>
                                                                            {{ $voucher->status }}</option>
    ...
    {{-- <script>
        ...
        //         var status = $(this).prop('checked') == true ? 'aktif' : 'expired';
