...
@section('content')
    ...
    <div class="card shadow-lg rounded card">
        <div class="card-header" id="#atas">
            ...
            <a href="{{ route('history.create') }}" class="btn btn-sm btn-primary"><svg xmlns="http://www.w3.org/2000/svg"
                        ...
                        @if (count($histories))
                            @foreach ($histories as $history)
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex">
                                            {{ $history->transaksi->kode_transaksi }}
                                        </div>
                                    </td>
                                    <td>
                                        <div class="d-flex">
                                            {{ $history->transaksi->keranjang->user->name }}
                                        </div>
                                    </td>
                                    <td>
                                        <div class="d-flex">
                                            {{ $history->transaksi->keranjang->produk->nama_produk }}
                                        </div>
                                    </td>
                                    <td>
                                        <div class="d-flex">
                                            {{ $history->transaksi->waktu_pemesanan }}
                                        </div>
                                    </td>
                                    <td>
