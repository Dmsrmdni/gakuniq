                        ...
                        @if (count($riwayat_produks))
                            @foreach ($riwayat_produks as $riwayat_produk)
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex">
                                            @if ($riwayat_produk->type == 'masuk')
                                                <div class="badge rounded-pill bg-success w-75">{{ $riwayat_produk->type }}
                                                </div>
                                    ...
                                    <td>
                                        <form action="{{ route('riwayat_produk.destroy', $riwayat_produk->id) }}"
                                            method="post">
                                            @csrf
                                            @method('delete')
                                            <button type="button" class="btn btn-sm btn-danger" data-bs-toggle="modal"
                                                data-bs-target="#modalCenter{{ $riwayat_produk->id }}"><svg
                                            ...
                                            <!-- Modal -->
                                            <div class="modal fade" id="modalCenter{{ $riwayat_produk->id }}" tabindex="-1"
                                                aria-hidden="true">
