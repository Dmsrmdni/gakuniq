                        ...
                        <td>
                            <form action="{{ route('riwayat_produk.destroy', $riwayat_produk->id) }}" method="post">
                                ...
                                <button type="button" class="btn btn-sm btn-danger" data-bs-toggle="modal"
                                    data-bs-target="#modalCenter{{ $riwayat_produk->id }}"><svg xmlns="http://www.w3.org/2000/svg" width="16"
                                ...
                                <!-- Modal -->
                                <div class="modal fade" id="modalCenter{{ $riwayat_produk->id }}" tabindex="-1" aria-hidden="true">
