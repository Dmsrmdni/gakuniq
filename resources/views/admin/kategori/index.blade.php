                    ...
                    <tr>
                        ...
                        <td>
                            <form action="{{ route('kategori.destroy', $kategori->id) }}" method="post">
                                @csrf
                                @method('delete')
                                <a href="{{ route('kategori.edit', $kategori->id) }}" class="btn btn-sm btn-secondary"
                                ...
                                <button type="button" class="btn btn-sm btn-danger" data-bs-toggle="modal"
                                    data-bs-target="#modalCenter{{ $kategori->id }}"><svg xmlns="http://www.w3.org/2000/svg" width="16"
                                ...
                                <!-- Modal -->
                                <div class="modal fade" id="modalCenter{{ $kategori->id }}" tabindex="-1" aria-hidden="true">
