                    ...
                    <tr>
                        ...
                        <td>
                            <form action="{{ route('keranjang.destroy', $keranjang->id) }}" method="post">
                                @csrf
                                @method('delete')
                                <a href="{{ route('keranjang.edit', $keranjang->id) }}" class="btn btn-sm btn-secondary"
                                ...
                                <button type="button" class="btn btn-sm btn-danger" data-bs-toggle="modal"
                                    data-bs-target="#modalCenter{{ $keranjang->id }}"><svg xmlns="http://www.w3.org/2000/svg" width="16"
                                ...
                                <!-- Modal -->
                                <div class="modal fade" id="modalCenter{{ $keranjang->id }}" tabindex="-1" aria-hidden="true">
