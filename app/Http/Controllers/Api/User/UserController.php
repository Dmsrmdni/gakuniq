...
class UserController extends Controller
{
    ...
    {
        $users = User::select("id", "nama_depan", "nama_belakang", "no_telepon", "username", "email" , "tanggal_lahir" , "jenis_kelamin" , "referensi" , "label_alamat" , "kota_kecamatan" , "alamat_lengkap" , "saldo" , "score")->where('id',auth()->guard('api')->user()->id)->get();
